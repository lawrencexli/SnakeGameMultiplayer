...
*/
    ...
    private void addFood(GameObject food, double x, double y)
    {
        ...
        switch (randomNum)
        {
            case 0: ((Circle) food.view).setFill(new ImagePattern(new Image("scrapCode/apple.png")));
                break;
            case 1: ((Circle) food.view).setFill(new ImagePattern(new Image("scrapCode/hamburger.png")));
                break;
            case 2: ((Circle) food.view).setFill(new ImagePattern(new Image("scrapCode/fries.png")));
                break;
        }
