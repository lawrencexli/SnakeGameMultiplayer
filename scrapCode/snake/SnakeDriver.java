...
public interface SnakeDriver
{
    class Snake extends GameObject
    {
        ...
        {
            ((Circle)lastTail.view).setFill(new ImagePattern(new Image("scrapCode/snakeHead.png")));
            ...
            if (this.bodyParts.size() > 0)
            {
                ...
                if (this.bodyParts.size() == 2 || this.bodyParts.size() == 1 || this.bodyParts.size() == 3 )
                    ((Circle) ((SnakeAppModel.SnakePart) this.bodyParts.getFirst()).view).setFill(new ImagePattern(new Image("scrapCode/snakeTail.png")));
                else
                    ((Circle) ((SnakeAppModel.SnakePart) this.bodyParts.getFirst()).view).setFill(new ImagePattern(new Image("scrapCode/snakeBody.png")));
            }
    ...
    class SnakePart extends GameObject
    {
        ...
        SnakePart(GameObject parent, GameObject head)
        {
            ...
            ((Circle)this.view).setFill(new ImagePattern(new Image("scrapCode/snakeTail.png")));
